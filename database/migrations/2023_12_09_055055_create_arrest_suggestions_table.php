...
return new class extends Migration {
    ...
    {
        Schema::create('arrest_suggestions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('arrest_id')->nullable()->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('arrest_suggestions');
    }
};
