@section('title')
    بوابة الحرية | قائمة تصنيفات الأسرى
@endsection
@section('style')
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">قائمة تصنيفات الأسرى</li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between flex-wrap mt-2">
                ...
                <div>
                    <input wire:model.live="Search" type="search" id="Search"
                           placeholder="البحث في قائمة تصنيفات الأسرى...">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered text-center">
                    ...
                    <tbody>
                    @foreach($PrisonerTypes as $key => $row)
                        <tr>
                            <td>{{$PrisonerTypes->firstItem() + $key}}</td>
                            <td>{{$row->prisoner_type_name ?? 'لا يوجد'}}</td>
                            <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-white">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="{{$showEdit ? 'updatePrisonerType':'createPrisonerType'}}">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="prisoner_type_name">اسم التصنيف</label>
                                <input wire:model="state.prisoner_type_name" type="text"
                                       class="form-control @error('prisoner_type_name') is-invalid @enderror"
                                       id="prisoner_type_name"
                                       placeholder="اسم التصنيف">
                                @error('prisoner_type_name')
                ...
                <div class="modal-footer d-flex justify-content-start align-items-start">
                    <button type="submit" wire:click="{{$showEdit ? 'updatePrisonerType':'createPrisonerType'}}"
                    ...
                    <span class="text-danger m-3">
                        * تنبية:
                        <span class="text-dark">
                            سيتم حذف {{$PrisonerTypes_->type_name ?? null}}
                        </span>
                    </span>
                </div>
                <div class="modal-footer d-flex justify-content-start align-items-start">
