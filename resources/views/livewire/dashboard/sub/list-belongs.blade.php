        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered text-center">
                    ...
                    <tbody>
                    @foreach($Belongs as $key => $row)
                        <tr>
                            <td>{{$Belongs->firstItem() + $key}}</td>
                            <td>{{$row->belong_name ?? 'لا يوجد'}}</td>
                            <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-white">
                ...
                <div class="modal-footer d-flex justify-content-start align-items-start">
                    <button type="submit" wire:click="{{$showEdit ? 'updateBelong':'createBelong'}}"
                    ...
                    <span class="text-danger m-3">
                        * تنبية:
                        <span class="text-dark">
                            سيتم حذف {{$Belongs_->belong_name ?? null}}
                        </span>
                    </span>
                </div>
                <div class="modal-footer d-flex justify-content-start align-items-start">
