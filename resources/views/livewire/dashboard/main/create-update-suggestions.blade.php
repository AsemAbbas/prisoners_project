    ...
    <div class="p-5">
        <div class="accordion" id="arrests">
            <form wire:submit.prevent="ReviewMassage">
                <div class="accordion-item col-md-6 mx-auto mb-3 p-0" wire:ignore.self>
                    <h2 class="accordion-header" id="panelsStayOpen-heading_prisoners">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#panelsStayOpen-collapse_prisoners" aria-expanded="true"
                                aria-controls="panelsStayOpen-collapse_prisoners">
                            بيانات الأسير/ة
                        </button>
                    </h2>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-4">
                                    <label style="font-weight: bold" for="error_suggester_name">اسم مقدم البيانات (رباعي)</label>
                                ...
                                <div class="form-group col-md-6 mb-4">
                                    <label style="font-weight: bold" for="suggester_identification_number">رقم هوية مقدم البيانات</label>
                                ...
                                <div class="form-group col-md-6 mb-4">
                                    <label style="font-weight: bold" for="suggester_phone_number">رقم هاتف مقدم البيانات (*059)</label>
                                    <input wire:model="state.suggester_phone_number" type="text"
                                           class="form-control @error('suggester_phone_number') is-invalid @enderror"
                                           id="suggester_phone_number"
                                           placeholder="رقم هاتف مقدم البيانات (*059)">
                                ...
                                <div class="form-group col-md-6 mb-4">
                                    <label style="font-weight: bold" for="relationship_id">صلة قرابة مقدم البيانات</label>
                                ...
                                @if(isset($state['arrest_type']) &&  in_array($state['arrest_type'],['محكوم','موقوف']))
                                    ...
                                    <div class="form-group col-md-4 mb-4">
                                        <label for="judgment_in_lifetime">
                                            الحكم
                                            @if($state['arrest_type'] === 'موقوف') المتوقع @endif
                                            بالمؤبدات
                                        </label>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.body.addEventListener('create_massage', function () {
                Swal.fire(
                    {
                        title: 'نجاح',
                        text: 'شكراً لك سيتم مراجعة البيانات خلال 24 ساعة',
                        icon: 'success',
