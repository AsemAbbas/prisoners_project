                                ...
                                <form>
                                    <select class="form-select z-index-9 bg-transparent" wire:model.live="NewsType"
                                        ...
                                        @foreach($NewsTypes as $newsType)
                                            <option style="color:#000;" value="{{$newsType->id}}">{{$newsType->news_type_name}}</option>
                                        @endforeach
                                    </select>
                                </form>
                            </div>
                ...
                @foreach($News as $row)
                    <div class="card border rounded-3 up-hover p-4 mb-4" style="direction: rtl">
                        <div class="row g-3">
                            <div class="col-lg-5">
                                <!-- Categories -->
                                <a href="#" class="badge text-bg-danger mb-2" style="background-color:{{$row->NewsType->news_type_color}}!important;"><i
