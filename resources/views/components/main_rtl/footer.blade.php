<footer id="footer">
    <div class="container" dir="rtl">
        ...
        <div class="row bg-dark py-5 mx-0 card card-header flex-row align-items-center text-center text-md-start">
            <!-- Copyright -->
            <div class="col-md-5 mb-3 mb-md-0" style="text-align: right;">
            ...
            <div class="col-md-4 text-center">
                <ul class="nav text-primary-hover justify-content-center justify-content-center">
                    ...
                    @endforeach
                        <span class="text-white">منصة إعلامية فلسطينية ، تتبع مكتب الشهداء والأسرى والجرحى في حركة المقاومة الإسلامية حماس. تهتم بقضايا الأسرى في سجون الإحتلال وتحديث بياناتهم.</span>
                </ul>
            </div>
        </div>
