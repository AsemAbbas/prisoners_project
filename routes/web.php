...
Route::prefix('dashboard')->group(function () {
    ...
    Route::get('/news', ListNews::class)->name('dashboard.news')->middleware(['auth', 'publisher']);
    ...
    Route::get('/confirms', ListPrisonerConfirms::class)->name('dashboard.confirms')->middleware('auth', 'admin');
    Route::get('/suggestions', ListPrisonerSuggestions::class)->name('dashboard.suggestions')->middleware('auth', 'editor');

    Route::get('/relatives_prisoners/{prisoner_id?}', ListRelativesPrisoners::class)->name('dashboard.relatives_prisoners')->middleware(['auth', 'admin']);
    Route::get('/cities', ListCities::class)->name('dashboard.cities')->middleware('auth', 'admin');
    Route::get('/belongs', ListBelongs::class)->name('dashboard.belongs')->middleware('auth', 'admin');
    Route::get('/prisoner_types', ListPrisonerTypes::class)->name('dashboard.prisoner_types')->middleware('auth', 'admin');
    Route::get('/news_types', ListNewsTypes::class)->name('dashboard.news_types')->middleware('auth', 'publisher');
    Route::get('/relationships', ListRelationships::class)->name('dashboard.relationships')->middleware('auth', 'admin');
    Route::get('/statistics', ListStatistics::class)->name('dashboard.statistics')->middleware('auth', 'admin');
    Route::get('/social_media', ListSocialMedia::class)->name('dashboard.social_media')->middleware('auth', 'admin');
});
