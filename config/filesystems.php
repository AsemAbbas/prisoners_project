...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'social_photo' => [
            'driver' => 'local',
            'root' => storage_path('app/public/social_photo'),
            'url' => env('APP_URL').'/storage/social_photo',
            'visibility' => 'public',
            'throw' => false,
        ],
        ...
        'news_photo' => [
            'driver' => 'local',
            'root' => storage_path('app/public/news_photo'),
            'url' => env('APP_URL').'/storage/news_photo',
            'visibility' => 'public',
            'throw' => false,
        ],
